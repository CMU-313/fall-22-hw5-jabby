...
/**
 * A header-based security filter that authenticates an user using the "X-Authenticated-User"
 * request header as the user ID. This filter is intended to be used in conjunction with an external
...
public class HeaderBasedSecurityFilter extends SecurityFilter {
  ...
  public void init(FilterConfig filterConfig) {
    enabled =
        Boolean.parseBoolean(filterConfig.getInitParameter("enabled"))
