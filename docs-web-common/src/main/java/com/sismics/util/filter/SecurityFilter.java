...
/**
 * An abstract security filter for user authentication, that injects corresponding users into the
 * request. Successfully authenticated users are injected as UserPrincipal, or as AnonymousPrincipal
 * otherwise. If an user has already been authenticated for the request, no further authentication
 * attempt is made.
 *
 * @author pacien
 * @author jtremeaux
