...
public class ClientUtil {
  ...
  public void createUser(String username, int quota, String... groupNameList) {
        ...
        .put(
            Entity.form(
                new Form()
                    ...
                    .param("storage_quota", String.valueOf(quota))),
            JsonObject.class);
    ...
    for (String groupName : groupNameList) {
      resource
          ...
          .request()
          .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
          .put(Entity.form(new Form().param("username", username)), JsonObject.class);
    }
  ...
  public void createGroup(String name, String parentId) {
    ...
    resource
        ...
        .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
        .put(
            Entity.form(new Form().param("name", name).param("parent", parentId)),
            JsonObject.class);
   ...
   */
  public String addFileToDocument(String file, String token, String documentId)
      ...
      try (FormDataMultiPart multiPart = new FormDataMultiPart()) {
        ...
        JsonObject json =
            this.resource
                ...
                .cookie(TokenBasedSecurityFilter.COOKIE_NAME, token)
                .put(
                    Entity.entity(formContent, MediaType.MULTIPART_FORM_DATA_TYPE),
                    JsonObject.class);
