...
public class TestFileUtil {
  ...
  public void extractContentOpenDocumentTextTest() throws Exception {
    ...
    FormatHandler formatHandler =
        FormatHandlerUtil.find(MimeTypeUtil.guessMimeType(path, "document.odt"));
  ...
  public void extractContentOfficeDocumentTest() throws Exception {
    ...
    FormatHandler formatHandler =
        FormatHandlerUtil.find(MimeTypeUtil.guessMimeType(path, "document.docx"));
    Assert.assertNotNull(formatHandler);
  ...
  public void extractContentPowerpointTest() throws Exception {
    ...
    FormatHandler formatHandler =
        FormatHandlerUtil.find(MimeTypeUtil.guessMimeType(path, "apache.pptx"));
    Assert.assertNotNull(formatHandler);
  ...
  public void extractContentPdf() throws Exception {
    ...
    FormatHandler formatHandler =
        FormatHandlerUtil.find(MimeTypeUtil.guessMimeType(path, "udhr.pdf"));
    Assert.assertNotNull(formatHandler);
    Assert.assertTrue(formatHandler instanceof PdfFormatHandler);
    String content = formatHandler.extractContent("eng", path);
    Assert.assertTrue(
        content.contains("All human beings are born free and equal in dignity and rights."));
  }
  ...
  public void extractContentScannedPdf() throws Exception {
    ...
    FormatHandler formatHandler =
        FormatHandlerUtil.find(MimeTypeUtil.guessMimeType(path, "scanned.pdf"));
    Assert.assertNotNull(formatHandler);
    Assert.assertTrue(formatHandler instanceof PdfFormatHandler);
    String content = formatHandler.extractContent("eng", path);
    Assert.assertTrue(
  ...
  public void convertToPdfTest() throws Exception {
    try (InputStream inputStream0 =
            Resources.getResource("file/apollo_landscape.jpg").openStream();
      ...
      Files.copy(
          inputStream0,
          DirectoryUtil.getStorageDirectory().resolve("apollo_landscape"),
      ...
      Files.copy(
          inputStream1,
          DirectoryUtil.getStorageDirectory().resolve("apollo_portrait"),
          StandardCopyOption.REPLACE_EXISTING);
      File file1 = new File();
      ...
      Files.copy(
          inputStream2,
          DirectoryUtil.getStorageDirectory().resolve("udhr"),
          StandardCopyOption.REPLACE_EXISTING);
      File file2 = new File();
      file2.setId("udhr");
      ...
      Files.copy(
          inputStream3,
          DirectoryUtil.getStorageDirectory().resolve("document_docx"),
          StandardCopyOption.REPLACE_EXISTING);
      File file3 = new File();
      ...
      Files.copy(
          inputStream4,
          DirectoryUtil.getStorageDirectory().resolve("document_odt"),
          StandardCopyOption.REPLACE_EXISTING);
      File file4 = new File();
      ...
      Files.copy(
          inputStream5,
          DirectoryUtil.getStorageDirectory().resolve("document_pptx"),
          StandardCopyOption.REPLACE_EXISTING);
      File file5 = new File();
      ...
      PdfUtil.convertToPdf(
          documentDto,
          Lists.newArrayList(file0, file1, file2, file3, file4, file5),
          true,
          true,
          10,
          outputStream);
