...
public class TestMimeTypeUtil {
  ...
  public void test() throws Exception {
    ...
    Assert.assertEquals(
        MimeType.OPEN_DOCUMENT_TEXT, MimeTypeUtil.guessMimeType(path, "document.odt"));
    ...
    Assert.assertEquals(
        MimeType.OFFICE_PRESENTATION, MimeTypeUtil.guessMimeType(path, "apache.pptx"));
    ...
    Assert.assertEquals(
        MimeType.IMAGE_JPEG, MimeTypeUtil.guessMimeType(path, "apollo_portrait.jpg"));
