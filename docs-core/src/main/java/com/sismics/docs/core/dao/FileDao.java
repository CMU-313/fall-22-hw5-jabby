...
public class FileDao {
  ...
  public List<File> findAll(int offset, int limit) {
    EntityManager em = ThreadLocalContext.get().getEntityManager();
    TypedQuery<File> q =
        em.createQuery("select f from File f where f.deleteDate is null", File.class);
  ...
  public List<File> findByUserId(String userId) {
    ...
    TypedQuery<File> q =
        em.createQuery(
            "select f from File f where f.userId = :userId and f.deleteDate is null", File.class);
  ...
  public List<File> getFiles(List<String> ids) {
    ...
    TypedQuery<File> q =
        em.createQuery(
            "select f from File f where f.id in :ids and f.deleteDate is null", File.class);
  ...
  public File getFile(String id, String userId) {
    ...
    TypedQuery<File> q =
        em.createQuery(
            "select f from File f where f.id = :id and f.userId = :userId and f.deleteDate is null",
            File.class);
  ...
  public void delete(String id, String userId) {
    ...
    TypedQuery<File> q =
        em.createQuery(
            "select f from File f where f.id = :id and f.deleteDate is null", File.class);
    q.setParameter("id", id);
  ...
  public List<File> getByDocumentId(String userId, String documentId) {
    ...
    if (documentId == null) {
      TypedQuery<File> q =
          em.createQuery(
              "select f from File f where f.documentId is null and f.deleteDate is null and f.latestVersion = true and f.userId = :userId order by f.createDate asc",
              File.class);
      q.setParameter("userId", userId);
      return q.getResultList();
    } else {
  ...
  public List<File> getByDocumentsIds(Iterable<String> documentIds) {
    ...
    TypedQuery<File> q =
        em.createQuery(
            "select f from File f where f.documentId in :documentIds and f.latestVersion = true and f.deleteDate is null order by f.order asc",
            File.class);
  ...
  public List<File> getByVersionId(String versionId) {
    ...
    TypedQuery<File> q =
        em.createQuery(
            "select f from File f where f.versionId = :versionId and f.deleteDate is null order by f.order asc",
            File.class);
