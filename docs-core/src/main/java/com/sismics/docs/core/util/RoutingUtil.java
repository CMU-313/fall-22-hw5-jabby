...
public class RoutingUtil {
   ...
   */
  public static void updateAcl(
      String documentId, RouteStepDto currentStep, RouteStepDto previousStep, String userId) {
  ...
  public static void sendRouteStepEmail(String documentId, RouteStepDto routeStepDto) {
    ...
    switch (AclTargetType.valueOf(routeStepDto.getTargetType())) {
      case USER:
        userDtoList.addAll(
            userDao.findByCriteria(new UserCriteria().setUserId(routeStepDto.getTargetId()), null));
        break;
      case GROUP:
        userDtoList.addAll(
            userDao.findByCriteria(
                new UserCriteria().setGroupId(routeStepDto.getTargetId()), null));
        break;
    }
