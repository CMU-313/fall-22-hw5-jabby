...
public class CommentDao {
  ...
  public List<CommentDto> getByDocumentId(String documentId) {
    ...
    StringBuilder sb =
        new StringBuilder(
            "select c.COM_ID_C, c.COM_CONTENT_C, c.COM_CREATEDATE_D, u.USE_USERNAME_C, u.USE_EMAIL_C from T_COMMENT c, T_USER u");
    sb.append(
        " where c.COM_IDDOC_C = :documentId and c.COM_IDUSER_C = u.USE_ID_C and c.COM_DELETEDATE_D is null ");
