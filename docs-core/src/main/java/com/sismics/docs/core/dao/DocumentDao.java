...
public class DocumentDao {
  ...
  public List<Document> findAll(int offset, int limit) {
    EntityManager em = ThreadLocalContext.get().getEntityManager();
    TypedQuery<Document> q =
        em.createQuery("select d from Document d where d.deleteDate is null", Document.class);
  ...
  public List<Document> findByUserId(String userId) {
    ...
    TypedQuery<Document> q =
        em.createQuery(
            "select d from Document d where d.userId = :userId and d.deleteDate is null",
            Document.class);
  ...
  public DocumentDto getDocument(String id, PermType perm, List<String> targetIdList) {
    ...
    StringBuilder sb =
        new StringBuilder(
            "select distinct d.DOC_ID_C, d.DOC_TITLE_C, d.DOC_DESCRIPTION_C, d.DOC_SUBJECT_C, d.DOC_IDENTIFIER_C, d.DOC_PUBLISHER_C, d.DOC_FORMAT_C, d.DOC_SOURCE_C, d.DOC_TYPE_C, d.DOC_COVERAGE_C, d.DOC_RIGHTS_C, d.DOC_CREATEDATE_D, d.DOC_UPDATEDATE_D, d.DOC_LANGUAGE_C, ");
    sb.append(
  ...
  public void delete(String id, String userId) {
    ...
    // Get the document
    TypedQuery<Document> dq =
        em.createQuery(
            "select d from Document d where d.id = :id and d.deleteDate is null", Document.class);
  ...
  public long getDocumentCount() {
    ...
    Query query =
        em.createNativeQuery(
            "select count(d.DOC_ID_C) from T_DOCUMENT d where d.DOC_DELETEDATE_D is null");
