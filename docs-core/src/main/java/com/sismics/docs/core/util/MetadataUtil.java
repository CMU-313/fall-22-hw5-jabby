...
public class MetadataUtil {
  ...
  public static void updateMetadata(
      String documentId, List<String> metadataIdList, List<String> metadataValueList)
      throws Exception {
    ...
    List<DocumentMetadataDto> documentMetadataDtoList =
        documentMetadataDao.getByDocumentId(documentId);
  ...
  public static void addMetadata(JsonObjectBuilder json, String documentId) {
    ...
    List<MetadataDto> metadataDtoList =
        metadataDao.findByCriteria(new MetadataCriteria(), new SortCriteria(1, true));
    List<DocumentMetadataDto> documentMetadataDtoList =
        documentMetadataDao.getByDocumentId(documentId);
