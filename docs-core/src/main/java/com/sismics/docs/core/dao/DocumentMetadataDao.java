...
public class DocumentMetadataDao {
  ...
  public List<DocumentMetadataDto> getByDocumentId(String documentId) {
    ...
    StringBuilder sb =
        new StringBuilder(
            "select dm.DME_ID_C, dm.DME_IDDOCUMENT_C, dm.DME_IDMETADATA_C, dm.DME_VALUE_C, m.MET_TYPE_C");
    sb.append(" from T_DOCUMENT_METADATA dm, T_METADATA m ");
    sb.append(
        " where dm.DME_IDMETADATA_C = m.MET_ID_C and dm.DME_IDDOCUMENT_C = :documentId and m.MET_DELETEDATE_D is null");
