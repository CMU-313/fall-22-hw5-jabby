...
public class ImageUtil {
  ...
  /**
   * Compute Gravatar hash. See https://en.gravatar.com/site/implement/hash/.
   *
   * @param email Email
  ...
  public static String computeGravatar(String email) {
    ...
    return Hashing.md5().hashString(email.trim().toLowerCase(), StandardCharsets.UTF_8).toString();
  }
