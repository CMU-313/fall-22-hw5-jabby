...
/**
 * Override of {@link freemarker.ext.beans.ResourceBundleModel} to threat single quotes uniformely.
 *
 * @author bgamard
 */
public class ResourceBundleModel extends freemarker.ext.beans.ResourceBundleModel {
  ...
  public Object exec(List arguments) throws TemplateModelException {
    ...
    if (arguments.size() < 1) throw new TemplateModelException("No message key was specified");
    // Read it
