...
public class TestDocumentResource extends BaseJerseyTest {
  ...
  public void testDocumentResource() throws Exception {
    ...
    JsonObject json =
        target()
            ...
            .put(
                Entity.form(new Form().param("name", "SuperTag").param("color", "#ffff00")),
                JsonObject.class);
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, document1Token)
            .put(
                Entity.form(new Form().param("name", "HR").param("color", "#0000ff")),
                JsonObject.class);
            ...
            .put(
                Entity.form(
                    new Form()
                        ...
                        .param("tags", tag2Id)
                        .param("language", "eng")
                        .param("create_date", Long.toString(create1Date))),
                JsonObject.class);
    ...
    // Add a file
    String file1Id =
        clientUtil.addFileToDocument(
            FILE_EINSTEIN_ROOSEVELT_LETTER_PNG, document1Token, document1Id);
            ...
            .put(
                Entity.form(
                    new Form()
                        ...
                        .param("language", "eng")
                        .param("create_date", Long.toString(create3Date))),
                JsonObject.class);
    String document3Id = json.getString("id");
    Assert.assertNotNull(document3Id);

    // Add a file
    clientUtil.addFileToDocument(FILE_EINSTEIN_ROOSEVELT_LETTER_PNG, document3Token, document3Id);
    ...
    Assert.assertEquals(
        2,
        searchDocuments(
            "at:" + DateTimeFormat.forPattern("yyyy").print(new Date().getTime()), document1Token));
    Assert.assertEquals(
        2,
        searchDocuments(
            "at:" + DateTimeFormat.forPattern("yyyy-MM").print(new Date().getTime()),
            document1Token));
    Assert.assertEquals(
        2,
        searchDocuments(
            "at:" + DateTimeFormat.forPattern("yyyy-MM-dd").print(new Date().getTime()),
            document1Token));
    Assert.assertEquals(2, searchDocuments("after:2010 before:2040-08", document1Token));
    Assert.assertEquals(
        2,
        searchDocuments(
            "uat:" + DateTimeFormat.forPattern("yyyy").print(new Date().getTime()),
            document1Token));
    Assert.assertEquals(
        2,
        searchDocuments(
            "uat:" + DateTimeFormat.forPattern("yyyy-MM").print(new Date().getTime()),
            document1Token));
    Assert.assertEquals(
        2,
        searchDocuments(
            "uat:" + DateTimeFormat.forPattern("yyyy-MM-dd").print(new Date().getTime()),
            document1Token));
    ...
    Assert.assertEquals(
        1,
        searchDocuments(
            "after:2010 before:2040-08 tag:super shared:yes lang:eng simple:title simple:description full:uranium",
            document1Token));
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, document1Token)
            .put(
                Entity.form(new Form().param("name", "SuperTag2").param("color", "#00ffff")),
                JsonObject.class);
            ...
            .post(
                Entity.form(
                    new Form()
                        ...
                        .param(
                            "description",
                            "My new super description for document\r\n\u00A0\u0009 1")
    ...
    response =
        target()
            .path("/document/69b79238-84bb-4263-a32f-9cbdf8c92188")
            .request()
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, document1Token)
            .delete();
    ...
    java.io.File thumbnailFile =
        DirectoryUtil.getStorageDirectory().resolve(file1Id + "_thumb").toFile();
  ...
  public void testOdtExtraction() throws Exception {
    ...
    Assert.assertTrue(
        fileBytes.length
            > 0); // Images rendered from PDF differ in size from OS to OS due to font issues
  ...
  public void testDocxExtraction() throws Exception {
    ...
    // Add a PDF file
    String file1Id =
        clientUtil.addFileToDocument(FILE_DOCUMENT_DOCX, documentDocxToken, document1Id);
  ...
  public void testPdfExtraction() throws Exception {
    ...
    // Add a PDF file
    String file1Id =
        clientUtil.addFileToDocument(FILE_WIKIPEDIA_PDF, documentPdfToken, document1Id);
  ...
  public void testPlainTextExtraction() throws Exception {
    ...
    String file1Id =
        clientUtil.addFileToDocument(FILE_DOCUMENT_TXT, documentPlainToken, document1Id);
  ...
  public void testEmlImport() throws Exception {
      ...
      try (FormDataMultiPart multiPart = new FormDataMultiPart()) {
        json =
            target()
                ...
                .put(
                    Entity.entity(
                        multiPart.bodyPart(streamDataBodyPart), MediaType.MULTIPART_FORM_DATA_TYPE),
                    JsonObject.class);
      }
    }
    ...
    Assert.assertEquals(
        "refugee status determination.pdf", files.getJsonObject(1).getString("name"));
  ...
  public void testCustomMetadata() {
    ...
    JsonObject json =
        target()
            ...
            .put(
                Entity.form(new Form().param("name", "0str").param("type", "STRING")),
                JsonObject.class);
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
            .put(
                Entity.form(new Form().param("name", "1int").param("type", "INTEGER")),
                JsonObject.class);
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
            .put(
                Entity.form(new Form().param("name", "2float").param("type", "FLOAT")),
                JsonObject.class);
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
            .put(
                Entity.form(new Form().param("name", "3date").param("type", "DATE")),
                JsonObject.class);
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
            .put(
                Entity.form(new Form().param("name", "4bool").param("type", "BOOLEAN")),
                JsonObject.class);
