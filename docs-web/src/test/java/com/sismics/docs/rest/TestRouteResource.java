...
public class TestRouteResource extends BaseJerseyTest {
  ...
  public void testRouteResource() throws Exception {
            ...
            .post(
                Entity.form(
                    new Form()
                        ...
                        .param("routeModelId", routeModels.getJsonObject(0).getString("id"))),
                JsonObject.class);
    ...
    Assert.assertEquals(
        "Check the document's metadata", documents.getJsonObject(0).getString("current_step_name"));
    ...
    json =
        target()
            ...
            .post(
                Entity.form(
                    new Form().param("documentId", document1Id).param("transition", "VALIDATED")),
                JsonObject.class);
    ...
    json =
        target()
            ...
            .post(
                Entity.form(
                    new Form().param("documentId", document1Id).param("transition", "APPROVED")),
                JsonObject.class);
  ...
  public void testTagActions() {
    ...
    JsonObject json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
            .put(
                Entity.form(new Form().param("name", "Approved").param("color", "#ff0000")),
                JsonObject.class);
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, adminToken)
            .put(
                Entity.form(new Form().param("name", "Pending").param("color", "#ff0000")),
                JsonObject.class);
            ...
            .put(
                Entity.form(
                    new Form()
                        ...
                        .param(
                            "steps",
                            "[{\"type\":\"APPROVE\",\"transitions\":[{\"name\":\"APPROVED\",\"actions\":[{\"type\":\"ADD_TAG\",\"tag\":\""
                                + tagApprovedId
                                + "\"}]},{\"name\":\"REJECTED\",\"actions\":[]}],\"target\":{\"name\":\"administrators\",\"type\":\"GROUP\"},\"name\":\"Check the document's metadata\"},{\"type\":\"VALIDATE\",\"transitions\":[{\"name\":\"VALIDATED\",\"actions\":[{\"type\":\"REMOVE_TAG\",\"tag\":\""
                                + tagPendingId
                                + "\"}]}],\"target\":{\"name\":\"administrators\",\"type\":\"GROUP\"},\"name\":\"Check the document's metadata\"}]")),
                JsonObject.class);
    ...
    target()
        ...
        .post(
            Entity.form(
                new Form().param("documentId", document2Id).param("transition", "REJECTED")),
            JsonObject.class);
    ...
    target()
        ...
        .post(
            Entity.form(
                new Form().param("documentId", document2Id).param("transition", "VALIDATED")),
            JsonObject.class);
