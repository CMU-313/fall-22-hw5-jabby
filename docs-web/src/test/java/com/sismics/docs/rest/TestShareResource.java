  ...
  public void testShareResource() throws Exception {
    ...
    JsonObject json =
        target()
            ...
            .put(
                Entity.form(
                    new Form().param("title", "File test document 1").param("language", "eng")),
                JsonObject.class);
      ...
      try (FormDataMultiPart multiPart = new FormDataMultiPart()) {
        json =
            target()
                ...
                .put(
                    Entity.entity(
                        multiPart.field("id", document1Id).bodyPart(streamDataBodyPart),
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, share1Token)
            .put(
                Entity.form(new Form().param("id", document1Id).param("name", "4 All")),
                JsonObject.class);
