  ...
  public void testTagResource() {
    ...
    Response response =
        target()
            ...
            .put(Entity.form(new Form().param("name", "Tag:3").param("color", "#ff0000")));
    ...
    JsonObject json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, tag1Token)
            .put(
                Entity.form(new Form().param("name", "Tag3").param("color", "#ff0000")),
                JsonObject.class);
    ...
    response =
        target()
            ...
            .request()
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, tag1Token)
            .put(Entity.form(new Form().param("name", "Tag 4")));
    Assert.assertEquals(Status.BAD_REQUEST, Status.fromStatusCode(response.getStatus()));
    ...
    Assert.assertEquals(
        document1Id, json.getJsonArray("documents").getJsonObject(0).getString("id"));
    Assert.assertEquals(
        document2Id, json.getJsonArray("documents").getJsonObject(1).getString("id"));
    ...
    Assert.assertEquals(
        document2Id, json.getJsonArray("documents").getJsonObject(0).getString("id"));
    ...
    json =
        target()
            ...
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, tag1Token)
            .post(
                Entity.form(new Form().param("name", "UpdatedName").param("color", "#0000ff")),
                JsonObject.class);
