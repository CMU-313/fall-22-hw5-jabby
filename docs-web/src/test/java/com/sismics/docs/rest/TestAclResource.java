  ...
  public void testAclResource() {
    ...
    json =
        target()
            ...
            .post(
                Entity.form(
                    new Form().param("title", "My new super document 1").param("language", "eng")),
                JsonObject.class);
    Assert.assertEquals(document1Id, json.getString("id"));
    ...
    target()
        .path("/acl/" + document1Id + "/WRITE/" + aclGroup2Id)
        .request()
        .cookie(TokenBasedSecurityFilter.COOKIE_NAME, acl2Token)
        .delete(JsonObject.class);
    ...
    target()
        .path("/acl/" + document1Id + "/READ/" + aclGroup2Id)
        .request()
        .cookie(TokenBasedSecurityFilter.COOKIE_NAME, acl1Token)
        .delete(JsonObject.class);
  ...
  public void testAclTags() {
    ...
    JsonObject json =
        target()
            ...
            .put(
                Entity.form(new Form().param("name", "AclTag1").param("color", "#ff0000")),
                JsonObject.class);
    ...
    response =
        target()
            ...
            .request()
            .cookie(TokenBasedSecurityFilter.COOKIE_NAME, acltag2Token)
            .post(Entity.form(new Form().param("name", "AclTag1").param("color", "#ff0000")));
    Assert.assertEquals(Status.NOT_FOUND.getStatusCode(), response.getStatus());
