...
public class AuditLogResource extends BaseResource {
   ...
   * @apiSuccess
   *     {String="Acl","Comment","Document","File","Group","Tag","User","RouteModel","Route"}
   *     logs.class Entity type
  ...
  public Response list(@QueryParam("document") String documentId) {
    ...
    JsonObjectBuilder response =
        Json.createObjectBuilder().add("logs", logs).add("total", paginatedList.getResultCount());
