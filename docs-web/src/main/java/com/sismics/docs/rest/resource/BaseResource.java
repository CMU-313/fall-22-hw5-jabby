...
public abstract class BaseResource {
  /**
   * @apiDefine admin Admin Only the admin user can access this resource
   */

  /**
   * @apiDefine user Authenticated user All authenticated users can access this resource
   */

  /**
   * @apiDefine none Anonymous user This resource can be accessed anonymously
   */
